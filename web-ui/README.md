...
- `/hardware/raspi/cpu_temperature` (`sensor_msgs/msg/Temperature`)
- `/hardware/vesc/left/status` (`vesc_msgs/msg/VescStateStamped`)
- `/hardware/vesc/right/status` (`vesc_msgs/msg/VescStateStamped`)
- `/hardware/vesc/mower/status` (`vesc_msgs/msg/VescStateStamped`)
